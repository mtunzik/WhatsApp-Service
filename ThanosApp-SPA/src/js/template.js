(function ($) {
	...
	$(document).ready(function () {
		...
		//new code: toogle sidebar-toogle-btn 
		$('body').on('click', '.sidebar-toggle-btn', function () {
			$('body').toggleClass('open-sidebar-menu')
		});

		//new code: close right bar
		$('body').on('click', '.rightbar .close-sidebar', function () {
			$('.rightbar').removeClass('open')
		});

		//new code: toogle dark mode control
		$('body').on('click', '.navigation .light-dark-toggle', function (e) {
			$(this).toggleClass('active')
			switchTheme(e)
		});

		// new code : rightbar toggle div (TODO)
		$('.rightbar .rightbar-link').on('click', function () {
			$('.rightbar').addClass('open')
		});
